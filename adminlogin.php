            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p>In your orphanage, cultural activities like dancing and exercise play a pivotal role in the children's holistic development.
                             Dancing serves as a means of creative expression, nurturing their self-confidence and emotional well-being, while exercise promotes physical health and lifelong fitness habits.
                              </p>
                        <p class="mb-4">These activities encourage teamwork and collaboration, imparting valuable social skills. Moreover, they expose the children to diverse traditions and art forms, fostering cultural awareness and respect for differences. 
                            Engaging in these activities bolsters self-esteem, offers a healthy outlet for emotions, and, most importantly, brings joy and a sense of belonging to the orphanage community, creating lasting, positive memories for the children.</p>
                        
                    </div>
                    <div class="col-lg-6 about-img wow fadeInUp" data-wow-delay="0.5s">
                        <div class="row">
                            <div class="col-12 text-center">
                                <img class="img-fluid w-75 rounded-circle bg-light p-3" src="img/cul3.jpg" alt="">
                            </div>
                            <div class="col-6 text-start" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3" src="img/cul2.jpg" alt="">
                            </div>
                            <div class="col-6 text-end" style="margin-top: -150px;">
                                <img class="img-fluid w-100 rounded-circle bg-light p-3" src="img/cul1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
